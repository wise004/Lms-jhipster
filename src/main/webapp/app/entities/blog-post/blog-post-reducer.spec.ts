...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './blog-post.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOGPOST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BLOGPOST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BLOGPOST actions', async () => {
      const arg = { id: 15145 };
    ...
    it('dispatches UPDATE_BLOGPOST actions', async () => {
      const arg = { id: 15145 };
    ...
    it('dispatches PARTIAL_UPDATE_BLOGPOST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BLOGPOST actions', async () => {
      const arg = 42666;
