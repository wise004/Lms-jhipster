...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENROLLMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENROLLMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENROLLMENT actions', async () => {
      const arg = { id: 1451 };
    ...
    it('dispatches UPDATE_ENROLLMENT actions', async () => {
      const arg = { id: 1451 };
    ...
    it('dispatches PARTIAL_UPDATE_ENROLLMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENROLLMENT actions', async () => {
      const arg = 42666;
