    ...
    <Row>
      <Col md="8">
        <h2 data-cy="categoryDetailsHeading">
          <Translate contentKey="edupressApp.category.detail.title">Category</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="edupressApp.category.name">Name</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.name}</dd>
          <dt>
            <span id="slug">
              <Translate contentKey="edupressApp.category.slug">Slug</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.slug}</dd>
          <dt>
            <span id="color">
              <Translate contentKey="edupressApp.category.color">Color</Translate>
            </span>
          </dt>
