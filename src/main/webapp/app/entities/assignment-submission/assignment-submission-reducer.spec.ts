...
import reducer, {
  ...
  reset,
  updateEntity,
} from './assignment-submission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSIGNMENTSUBMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSIGNMENTSUBMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSIGNMENTSUBMISSION actions', async () => {
      const arg = { id: 31697 };
    ...
    it('dispatches UPDATE_ASSIGNMENTSUBMISSION actions', async () => {
      const arg = { id: 31697 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSIGNMENTSUBMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSIGNMENTSUBMISSION actions', async () => {
      const arg = 42666;
