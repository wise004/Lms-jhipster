...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './course.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSE actions', async () => {
      const arg = { id: 3722 };
    ...
    it('dispatches UPDATE_COURSE actions', async () => {
      const arg = { id: 3722 };
    ...
    it('dispatches PARTIAL_UPDATE_COURSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURSE actions', async () => {
      const arg = 42666;
