...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUIZATTEMPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUIZATTEMPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUIZATTEMPT actions', async () => {
      const arg = { id: 14875 };
    ...
    it('dispatches UPDATE_QUIZATTEMPT actions', async () => {
      const arg = { id: 14875 };
    ...
    it('dispatches PARTIAL_UPDATE_QUIZATTEMPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUIZATTEMPT actions', async () => {
      const arg = 42666;
