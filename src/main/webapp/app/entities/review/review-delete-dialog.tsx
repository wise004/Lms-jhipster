...
export const ReviewDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/review${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="edupressApp.review.delete.question">
        <Translate contentKey="edupressApp.review.delete.question" interpolate={{ id: reviewEntity.id }}>
