...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './lesson.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LESSON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LESSON actions', async () => {
      const arg = { id: 25298 };
    ...
    it('dispatches UPDATE_LESSON actions', async () => {
      const arg = { id: 25298 };
    ...
    it('dispatches PARTIAL_UPDATE_LESSON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LESSON actions', async () => {
      const arg = 42666;
