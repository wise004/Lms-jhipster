...
/**
 * Criteria class for the {@link com.edupress.domain.Category} entity. This class is used
 * in {@link com.edupress.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, slug, color, distinct);
    }
